...
export class ProductControllerBase {
  ...
  @common.Get("/:id/variasi")
  @ApiNestedQuery(VariasiFindManyArgs)
  async findManyVariasi(
    @common.Req() request: Request,
    @common.Param() params: ProductWhereUniqueInput
  ): Promise<Variasi[]> {
    const query = plainToClass(VariasiFindManyArgs, request.query);
    const results = await this.service.findVariasi(params.id, {
      ...query,
      select: {
        createdAt: true,
        gambar: true,
  ...
  @common.Post("/:id/variasi")
  async connectVariasi(
    @common.Param() params: ProductWhereUniqueInput,
    @common.Body() body: VariasiWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      variasi: {
        connect: body,
  ...
  @common.Delete("/:id/variasi")
  async disconnectVariasi(
    @common.Param() params: ProductWhereUniqueInput,
    @common.Body() body: VariasiWhereUniqueInput[]
  ): Promise<void> {
    const data = {
